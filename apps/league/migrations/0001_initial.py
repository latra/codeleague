    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('data_start_inscription', models.DateTimeField(default=datetime.datetime.now)),
                ('data_finish_inscription', models.DateTimeField(default=datetime.datetime.now)),
                ('data_start_competition', models.DateTimeField(default=datetime.datetime.now)),
                ('data_finish_competition', models.DateTimeField(default=datetime.datetime.now)),
